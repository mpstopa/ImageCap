...
#    print("input_transfer_values",input_transfer_values)
...
#            print("i",i,"caption",caption,"input_data['decoder_input]",input_data['decoder_input'])

            decoder_output = decoder_model.predict(input_data)
            
#            print("len(decoder_output)",len(decoder_output))
    ...
    if attn and get_weights:
        return res_captions, probs, weights, output_transfer_values
    else:
        return res_captions, probs, output_transfer_values
